# Galt Project Galt Token (ERC20) (@galtproject/galt-token)

[![Build Status](https://travis-ci.org/galtspace/galtproject-galt-token.svg?branch=master)](https://travis-ci.org/galtspace/galtproject-galt-token)
